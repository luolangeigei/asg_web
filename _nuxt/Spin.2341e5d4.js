...
`,[p(">",[B("scrollbar-container",`
 ...
 `)])]),Bn={small:20,medium:18,large:16},zn=Object.assign(Object.assign({},N.props),{description:String,stroke:String,size:{type:[String,Number],default:"medium"},show:{type:Boolean,default:!0},strokeWidth:Number,rotate:{type:Boolean,default:!0},spinning:{type:Boolean,validator:()=>!0,default:void 0}}),Xn=ne({name:"Spin",props:zn,setup(n){const{mergedClsPrefixRef:l,inlineThemeDisabled:i}=we(n),c=N("Spin","-spin",xn,yn,n,l),r=h(()=>{const{size:a}=n,{common:{cubicBezierEaseInOut:m},self:w}=c.value,{opacitySpinning:z,color:S,textColor:y}=w,C=typeof a=="number"?cn(a):w[sn("size",a)];return{"--n-bezier":m,"--n-opacity-spinning":z,"--n-size":C,"--n-color":S,"--n-text-color":y}}),v=i?Se("spin",h(()=>{const{size:a}=n;return typeof a=="number"?String(a):a[0]}),r,n):void 0;return{mergedClsPrefix:l,compitableShow:un(n,["spinning","show"]),mergedStrokeWidth:h(()=>{const{strokeWidth:a}=n;if(a!==void 0)return a;const{size:m}=n;return Bn[typeof m=="number"?"medium":m]}),cssVars:i?void 0:r,themeClass:v==null?void 0:v.themeClass,onRender:v==null?void 0:v.onRender}},render(){var n,l;const{$slots:i,mergedClsPrefix:c,description:r}=this,v=i.icon&&this.rotate,a=(r||i.description)&&d("div",{class:`${c}-spin-description`},r||((n=i.description)===null||n===void 0?void 0:n.call(i))),m=i.icon?d("div",{class:[`${c}-spin-body`,this.themeClass]},d("div",{class:[`${c}-spin`,v&&`${c}-spin--rotate`],style:i.default?"":this.cssVars},i.icon()),a):d("div",{class:[`${c}-spin-body`,this.themeClass]},d(rn,{clsPrefix:c,style:i.default?"":this.cssVars,stroke:this.stroke,"stroke-width":this.mergedStrokeWidth,class:`${c}-spin`}),a);return(l=this.onRender)===null||l===void 0||l.call(this),i.default?d("div",{class:[`${c}-spin-container`,this.themeClass],style:this.cssVars},d("div",{class:[`${c}-spin-content`,this.compitableShow&&`${c}-spin-content--spinning`]},i),d(ee,{name:"fade-in-transition"},{default:()=>this.compitableShow?m:null})):m}});export{Pn as N,Wn as X,Xn as _,un as a,vn as b,wn as c,hn as d,Rn as e,Re as f,Ln as m,bn as s,Hn as u};
