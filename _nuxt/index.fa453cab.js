...
`,[a("slides",`
 ...
 `)])])]),Yn=["transitionDuration","transitionTimingFunction"],Zn=Object.assign(Object.assign({},ne.props),{defaultIndex:{type:Number,default:0},currentIndex:Number,showArrow:Boolean,dotType:{type:String,default:"dot"},dotPlacement:{type:String,default:"bottom"},slidesPerView:{type:[Number,String],default:1},spaceBetween:{type:Number,default:0},centeredSlides:Boolean,direction:{type:String,default:"horizontal"},autoplay:Boolean,interval:{type:Number,default:5e3},loop:{type:Boolean,default:!0},effect:{type:String,default:"slide"},showDots:{type:Boolean,default:!0},trigger:{type:String,default:"click"},transitionStyle:{type:Object,default:()=>({transitionDuration:"300ms"})},transitionProps:Object,draggable:Boolean,prevSlideStyle:[Object,String],nextSlideStyle:[Object,String],touchable:{type:Boolean,default:!0},mousewheel:Boolean,keyboard:Boolean,"onUpdate:currentIndex":Function,onUpdateCurrentIndex:Function});let je=!1;const qn=O({name:"Carousel",props:Zn,setup(e){const{mergedClsPrefixRef:n,inlineThemeDisabled:o}=Y(e),r=X(null),l=X(null),s=X([]),b={value:[]},g=w(()=>e.direction==="vertical"),y=w(()=>g.value?"height":"width"),v=w(()=>g.value?"bottom":"right"),d=w(()=>e.effect==="slide"),m=w(()=>e.loop&&e.slidesPerView===1&&d.value),S=w(()=>e.effect==="custom"),V=w(()=>!d.value||e.centeredSlides?1:e.slidesPerView),D=w(()=>S.value?1:e.slidesPerView),C=w(()=>V.value==="auto"||e.slidesPerView==="auto"&&e.centeredSlides),x=X({width:0,height:0}),z=w(()=>{const{value:t}=s;if(!t.length)return[];const{value:i}=C;if(i)return t.map(P=>ut(P));const{value:c}=D,{value:h}=x,{value:_}=y;let p=h[_];if(c!=="auto"){const{spaceBetween:P}=e,L=p-(c-1)*P,_e=1/Math.max(1,c);p=L*_e}const $=Object.assign(Object.assign({},h),{[_]:p});return t.map(()=>$)}),k=w(()=>{const{value:t}=z;if(!t.length)return[];const{centeredSlides:i,spaceBetween:c}=e,{value:h}=y,{[h]:_}=x.value;let p=0;return t.map(({[h]:$})=>{let P=p;return i&&(P+=($-_)/2),p+=$+c,P})}),M=X(!1),B=w(()=>{const{transitionStyle:t}=e;return t?rt(t,Yn):{}}),H=w(()=>S.value?0:Mn(B.value.transitionDuration)),q=w(()=>{const{value:t}=s;if(!t.length)return[];const i=!(C.value||D.value===1),c=$=>{if(i){const{value:P}=y;return{[P]:`${z.value[$][P]}px`}}};if(S.value)return t.map(($,P)=>c(P));const{effect:h,spaceBetween:_}=e,{value:p}=v;return t.reduce(($,P,L)=>{const _e=Object.assign(Object.assign({},c(L)),{[`margin-${p}`]:`${_}px`});return $.push(_e),M.value&&(h==="fade"||h==="card")&&Object.assign(_e,B.value),$},[])}),A=w(()=>{const{value:t}=V,{length:i}=s.value;if(t!=="auto")return Math.max(i-t,0)+1;{const{value:c}=z,{length:h}=c;if(!h)return i;const{value:_}=k,{value:p}=y,$=x.value[p];let P=c[c.length-1][p],L=h;for(;L>1&&P<$;)L--,P+=_[L]-_[L-1];return ye(L+1,1,h)}}),G=w(()=>An(A.value,m.value)),Re=Ve(e.defaultIndex,m.value),oe=X(ct(Re,A.value,m.value)),F=pt(xt(e,"currentIndex"),oe),U=w(()=>Ve(F.value,m.value));function ie(t){var i,c;t=ye(t,0,A.value-1);const h=ct(t,A.value,m.value),{value:_}=F;h!==F.value&&(oe.value=h,(i=e["onUpdate:currentIndex"])===null||i===void 0||i.call(e,h,_),(c=e.onUpdateCurrentIndex)===null||c===void 0||c.call(e,h,_))}function ue(t=U.value){return jn(t,A.value,e.loop)}function fe(t=U.value){return Bn(t,A.value,e.loop)}function $t(t){const i=Q(t);return i!==null&&ue()===i}function Pt(t){const i=Q(t);return i!==null&&fe()===i}function Xe(t){return U.value===Q(t)}function Nt(t){return F.value===t}function Ke(){return ue()===null}function He(){return fe()===null}function $e(t){const i=ye(Ve(t,m.value),0,A.value);(t!==F.value||i!==U.value)&&ie(i)}function Pe(){const t=ue();t!==null&&ie(t)}function me(){const t=fe();t!==null&&ie(t)}function It(){(!W||!m.value)&&Pe()}function kt(){(!W||!m.value)&&me()}let W=!1,Z=0;const Ne=X({});function pe(t,i=0){Ne.value=Object.assign({},B.value,{transform:g.value?`translateY(${-t}px)`:`translateX(${-t}px)`,transitionDuration:`${i}ms`})}function re(t=0){d.value?Ie(U.value,t):Z!==0&&(!W&&t>0&&(W=!0),pe(Z=0,t))}function Ie(t,i){const c=Ye(t);c!==Z&&i>0&&(W=!0),Z=Ye(U.value),pe(c,i)}function Ye(t){let i;return t>=A.value-1?i=Ze():i=k.value[t]||0,i}function Ze(){if(V.value==="auto"){const{value:t}=y,{[t]:i}=x.value,{value:c}=k,h=c[c.length-1];let _;if(h===void 0)_=i;else{const{value:p}=z;_=h+p[p.length-1][t]}return _-i}else{const{value:t}=k;return t[A.value-1]||0}}const le={currentIndexRef:F,to:$e,prev:It,next:kt,isVertical:()=>g.value,isHorizontal:()=>!g.value,isPrev:$t,isNext:Pt,isActive:Xe,isPrevDisabled:Ke,isNextDisabled:He,getSlideIndex:Q,getSlideStyle:Dt,addSlide:Tt,removeSlide:Et,onCarouselItemClick:Vt};Ln(le);function Tt(t){t&&s.value.push(t)}function Et(t){if(!t)return;const i=Q(t);i!==-1&&s.value.splice(i,1)}function Q(t){return typeof t=="number"?t:t?s.value.indexOf(t):-1}function Dt(t){const i=Q(t);if(i!==-1){const c=[q.value[i]],h=le.isPrev(i),_=le.isNext(i);return h&&c.push(e.prevSlideStyle||""),_&&c.push(e.nextSlideStyle||""),tn(c)}}function Vt(t,i){let c=!W&&!ge&&!De;e.effect==="card"&&c&&!Xe(t)&&($e(t),c=!1),c||(i.preventDefault(),i.stopPropagation())}let ve=null;function he(){ve&&(clearInterval(ve),ve=null)}function J(){he(),!e.autoplay||G.value<2||(ve=window.setInterval(me,e.interval))}let ke=0,Te=0,K=0,Ee=0,ge=!1,De=!1;function qe(t){var i;if(je||!(!((i=l.value)===null||i===void 0)&&i.contains(Pn(t))))return;je=!0,ge=!0,De=!1,Ee=Date.now(),he(),t.type!=="touchstart"&&!t.target.isContentEditable&&t.preventDefault();const c=dt(t)?t.touches[0]:t;g.value?Te=c.clientY:ke=c.clientX,e.touchable&&(ce("touchmove",document,xe,{passive:!0}),ce("touchend",document,ee),ce("touchcancel",document,ee)),e.draggable&&(ce("mousemove",document,xe),ce("mouseup",document,ee))}function xe(t){const{value:i}=g,{value:c}=y,h=dt(t)?t.touches[0]:t,_=i?h.clientY-Te:h.clientX-ke,p=x.value[c];K=ye(_,-p,p),t.cancelable&&t.preventDefault(),d.value&&pe(Z-K,0)}function ee(){const{value:t}=U;let i=t;if(!W&&K!==0&&d.value){const c=Z-K,h=[...k.value.slice(0,A.value-1),Ze()];let _=null;for(let p=0;p<h.length;p++){const $=Math.abs(h[p]-c);if(_!==null&&_<$)break;_=$,i=p}}if(i===t){const c=Date.now()-Ee,{value:h}=y,_=x.value[h];K>_/2||K/c>.4?i=ue(t):(K<-_/2||K/c<-.4)&&(i=fe(t))}i!==null&&i!==t?(De=!0,ie(i),Je(()=>{(!m.value||oe.value!==F.value)&&re(H.value)})):re(H.value),Ge(),J()}function Ge(){ge&&(je=!1),ge=!1,ke=0,Te=0,K=0,Ee=0,de("touchmove",document,xe),de("touchend",document,ee),de("touchcancel",document,ee),de("mousemove",document,xe),de("mouseup",document,ee)}function jt(){if(d.value&&W){const{value:t}=U;Ie(t,0)}else J();d.value&&(Ne.value.transitionDuration="0ms"),W=!1}function Bt(t){if(t.preventDefault(),W)return;let{deltaX:i,deltaY:c}=t;t.shiftKey&&!i&&(i=c);const h=-1,_=1,p=(i||c)>0?_:h;let $=0,P=0;g.value?P=p:$=p;const L=10;(P*c>=L||$*i>=L)&&(p===_&&!He()?me():p===h&&!Ke()&&Pe())}function At(){x.value=ut(r.value,!0),J()}function Mt(){var t,i;C.value&&((i=(t=z.effect).scheduler)===null||i===void 0||i.call(t),z.effect.run())}function Lt(){e.autoplay&&he()}function Ot(){e.autoplay&&J()}ht(()=>{Qt(J),requestAnimationFrame(()=>M.value=!0)}),gt(()=>{Ge(),he()}),Jt(()=>{const{value:t}=s,{value:i}=b,c=new Map,h=p=>c.has(p)?c.get(p):-1;let _=!1;for(let p=0;p<t.length;p++){const $=i.findIndex(P=>P.el===t[p]);$!==p&&(_=!0),c.set(t[p],$)}_&&t.sort((p,$)=>h(p)-h($))}),be(U,(t,i)=>{if(t!==i)if(J(),d.value){if(m.value&&G.value>2){const{value:c}=A;t===c-2&&i===1?t=0:t===1&&i===c-2&&(t=c-1)}Ie(t,H.value)}else re()},{immediate:!0}),be([m,V],()=>void Je(()=>{ie(U.value)})),be(k,()=>{d.value&&re()},{deep:!0}),be(d,t=>{t?re():(W=!1,pe(Z=0))});const Ft=w(()=>({onTouchstartPassive:e.touchable?qe:void 0,onMousedown:e.draggable?qe:void 0,onWheel:e.mousewheel?Bt:void 0})),Ut=w(()=>Object.assign(Object.assign({},rt(le,["to","prev","next","isPrevDisabled","isNextDisabled"])),{total:G.value,currentIndex:F.value})),Wt=w(()=>({total:G.value,currentIndex:F.value,to:le.to})),Xt={getCurrentIndex:()=>F.value,to:$e,prev:Pe,next:me},Kt=ne("Carousel","-carousel",Hn,Sn,e,n),Qe=w(()=>{const{common:{cubicBezierEaseInOut:t},self:{dotSize:i,dotColor:c,dotColorActive:h,dotColorFocus:_,dotLineWidth:p,dotLineWidthActive:$,arrowColor:P}}=Kt.value;return{"--n-bezier":t,"--n-dot-color":c,"--n-dot-color-focus":_,"--n-dot-color-active":h,"--n-dot-size":i,"--n-dot-line-width":p,"--n-dot-line-width-active":$,"--n-arrow-color":P}}),te=o?Fe("carousel",void 0,Qe,e):void 0;return Object.assign(Object.assign({mergedClsPrefix:n,selfElRef:r,slidesElRef:l,slideVNodes:b,duplicatedable:m,userWantsControl:S,autoSlideSize:C,displayIndex:F,realIndex:U,slideStyles:q,translateStyle:Ne,slidesControlListeners:Ft,handleTransitionEnd:jt,handleResize:At,handleSlideResize:Mt,handleMouseenter:Lt,handleMouseleave:Ot,isActive:Nt,arrowSlotProps:Ut,dotSlotProps:Wt},Xt),{cssVars:o?void 0:Qe,themeClass:te==null?void 0:te.themeClass,onRender:te==null?void 0:te.onRender})},render(){var e;const{mergedClsPrefix:n,showArrow:o,userWantsControl:r,slideStyles:l,dotType:s,dotPlacement:b,slidesControlListeners:g,transitionProps:y={},arrowSlotProps:v,dotSlotProps:d,$slots:{default:m,dots:S,arrow:V}}=this,D=m&&_n(m())||[];let C=Gn(D);return C.length||(C=D.map(x=>u(St,null,{default:()=>vt(x)}))),this.duplicatedable&&(C=Vn(C)),this.slideVNodes.value=C,this.autoSlideSize&&(C=C.map(x=>u(lt,{onResize:this.handleSlideResize},{default:()=>x}))),(e=this.onRender)===null||e===void 0||e.call(this),u("div",Object.assign({ref:"selfElRef",class:[this.themeClass,`${n}-carousel`,this.direction==="vertical"&&`${n}-carousel--vertical`,this.showArrow&&`${n}-carousel--show-arrow`,`${n}-carousel--${b}`,`${n}-carousel--${this.direction}`,`${n}-carousel--${this.effect}`,r&&`${n}-carousel--usercontrol`],style:this.cssVars},g,{onMouseenter:this.handleMouseenter,onMouseleave:this.handleMouseleave}),u(lt,{onResize:this.handleResize},{default:()=>u("div",{ref:"slidesElRef",class:`${n}-carousel__slides`,role:"listbox",style:this.translateStyle,onTransitionend:this.handleTransitionEnd},r?C.map((x,z)=>u("div",{style:l[z],key:z},_t(u(en,Object.assign({},y),{default:()=>x}),[[bt,this.isActive(z)]]))):C)}),this.showDots&&d.total>1&&ze(S,d,()=>[u(Fn,{key:s+b,total:d.total,currentIndex:d.currentIndex,dotType:s,trigger:this.trigger,keyboard:this.keyboard})]),o&&ze(V,v,()=>[u(Xn,null)]))}});function Gn(e){return e.reduce((n,o)=>(Kn(o)&&n.push(o),n),[])}const Qn=R("collapse","width: 100%;",[R("collapse-item",`
